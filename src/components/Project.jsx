...
export default function Project({info}) {
    const {title, description, link, repo, image} = info;
  return (

    <div className='w-full md:w-1/2 lg:w-1/3 h-64 p-2'>
      
        <div className='h-full rounded overflow-hidden relative group '>
          ...
          <div className='group md:invisible md:group-hover:visible absolute p-2 text-sky-400 font-bold w-full h-full text-2xl flex flex-col justify-between'>
            <div className='flex flex-col h-full'>
              <h1 class="bg-gradient-to-r from-sky-700 to-blue-900 rounded  text-center text-white">{title}</h1>
